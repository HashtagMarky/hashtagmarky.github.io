# #M Productions — Brand & Content Plan

**Version 2.1 · May 2026**

> Index of all brand and content documentation. Load the specific file relevant to your task rather than this whole directory.

-----

| File | Contents | Load when |
|---|---|---|
| [brand-identity.md](brand-identity.md) | Who is HashtagMarky, brand pillars, tone of voice, domain options | Brand/tone questions, domain setup |
| [website-architecture.md](website-architecture.md) | Tech stack, site map, folder structure, adding new projects | Making site changes, adding pages |
